...
set :deploy_to, '/web/chat_client'
set :current_path, 'current'
set :repository, 'https://github.com/XAINI/chat_client.git'
set :branch, 'master'
set :user, 'root'
set :term_mode, nil
...
task :setup => :environment do
  ...
  order = MinaUtil::Builder.ask_mongoid('chat_client')
  ...
  nginx = MinaUtil::Builder.ask_nginx('chat_client', '/web/chat_client')
  queue! %[echo '#{nginx}' > "/etc/nginx/conf.d/chat_client.conf"]
  #test
  #queue! %[echo '#{nginx}' > "/home/dd/chat_client.conf"]
